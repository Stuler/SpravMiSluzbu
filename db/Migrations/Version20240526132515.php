 ...
 */
final class Version20240526132515 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, login_role_id INT DEFAULT NULL, nick VARCHAR(100) NOT NULL, email VARCHAR(100) NOT NULL, password VARCHAR(100) DEFAULT NULL, date_last_login DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, note LONGTEXT DEFAULT NULL, date_created DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, date_modified DATETIME DEFAULT CURRENT_TIMESTAMP, date_deleted DATETIME DEFAULT NULL, created_by INT NOT NULL, deleted_by INT DEFAULT NULL, INDEX IDX_8D93D649C62E3CD1 (login_role_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
